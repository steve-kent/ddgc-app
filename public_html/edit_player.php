...
<div id="container">
        ...
        <div id='playerFormContainer'>
            <div id='playerInfo'>
                ...
                <form id='addPlayer' name='addPlayer' method='post' action='validateEditPlayer.php' onsubmit='return validateForm(this)'>
                    ...
                    <input type='radio' class='disableClicks' name='memberRadio' id='isMember' value='isMember' <?= $ph->IsMember($player['Expires']) ? ' checked ' : '' ?> readonly> Yes
                    <input type='radio' class='disableClicks' name='memberRadio' id='notMember' value='notMember' <?= $ph->IsMember($player['Expires']) ? '' : ' checked ' ?>> No <br>
                    ...
                    Membership Exp: <input class='memberFields' readonly type='date' id='expireDate' name='expireDate' value='<?= FormatOutput($player['Expires']) ?>'><br>


                    Owed a shirt?: <input class='memberFields disableClicks' readonly type='checkbox' name='oweShirt' id='oweShirt' value='oweShirt' <?= $player['OweShirt'] ? ' checked ' : '' ?>><br>
    ...
    ?>
        <div id='playerFormContainer' \>
            <div class="button manageButtons"><a href="add_announcement.php">Add Announcement</a></div>
            <div class="button manageButtons"><a href="add_event.php">Add Upcoming Event</a></div><br />
            <div class="button manageButtons"><a href="owed_shirt.php">Who's Owed a Shirt?</a></div>
            <div class="button manageButtons"><a href="member_emails.php">Member Email Addresses</a></div><br/>
            <div class="button manageButtons"><a href="expiring_members.php">Expiring Memberships</a></div>
        </div>
    <?php
    }
    ?>
